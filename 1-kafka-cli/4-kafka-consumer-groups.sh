...
kafka-consumer-groups --command-config playground.config --bootstrap-server <my-boostrap-server> --list
 
# describe one specific group
kafka-consumer-groups --command-config playground.config --bootstrap-server <my-boostrap-server> --describe --group my-second-application
...
# start a consumer
kafka-console-consumer --consumer.config playground.config --bootstrap-server <my-boostrap-server> --topic first_topic --group my-first-application

# describe the group now
kafka-consumer-groups --command-config playground.config --bootstrap-server <my-boostrap-server> --describe --group my-first-application

# describe a console consumer group (change the end number)
kafka-consumer-groups --command-config playground.config --bootstrap-server <my-boostrap-server> --describe --group console-consumer-10592

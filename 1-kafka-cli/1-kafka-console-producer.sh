...
kafka-topics --command-config playground.config --bootstrap-server <my-boostrap-server> --topic first_topic --create --partitions 1

# producing
kafka-console-producer --producer.config playground.config --bootstrap-server <my-boostrap-server> --topic first_topic
>Hello World
...
kafka-console-producer --producer.config playground.config --bootstrap-server <my-boostrap-server> --topic first_topic --producer-property acks=all
...
kafka-console-producer --producer.config playground.config --bootstrap-server <my-boostrap-server> --topic new_topic
> hello world!
...
# produce with keys
kafka-console-producer --producer.config playground.config --bootstrap-server <my-boostrap-server> --topic first_topic --property parse.key=true --property key.separator=:

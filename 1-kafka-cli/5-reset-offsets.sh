...
kafka-consumer-groups --command-config playground.config --bootstrap-server crucial-elephant-12008-eu1-kafka.upstash.io:9092 --group my-first-application --reset-offsets --to-earliest --topic third_topic --dry-run

# execute flag is needed
kafka-consumer-groups --command-config playground.config --bootstrap-server crucial-elephant-12008-eu1-kafka.upstash.io:9092 --group my-first-application --reset-offsets --to-earliest --topic third_topic --execute
